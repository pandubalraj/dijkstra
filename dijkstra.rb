...
spalgorithm = SPAlgorithm.new
(1..6).each {|node| spalgorithm.push node }
spalgorithm.connect_mutually 1, 2, 7
spalgorithm.connect_mutually 1, 3, 9
spalgorithm.connect_mutually 1, 6, 14
spalgorithm.connect_mutually 2, 3, 10
spalgorithm.connect_mutually 2, 4, 15
spalgorithm.connect_mutually 3, 4, 11
spalgorithm.connect_mutually 3, 6, 2
spalgorithm.connect_mutually 4, 5, 6
spalgorithm.connect_mutually 5, 6, 9

p spalgorithm
p spalgorithm.length_between(2, 1)
p spalgorithm.neighbors(1)
p spalgorithm.dijkstra(1) 
p spalgorithm.dijkstra(1, 5) 